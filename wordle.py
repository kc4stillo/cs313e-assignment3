...
# TODO: Modify this function. You may delete this comment when you are done.
def is_valid_guess(guess, valid_guesses, secret):
    """
    ...
    if len(guess) == 5 and guess.isalpha() and guess in valid_guesses or guess == secret:
        return True
    else:
        return False
...
def main():
    ...
    while attempts > 0:
        ...
        if not is_valid_guess(guess, valid_guesses, secret_word):
            print(INVALID_INPUT)
            continue
